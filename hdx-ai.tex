...
\begin{frame}{The CIA Triad: Foundation of Information Security}
    ...
    \begin{tikzpicture}
        ...
        % All circles exactly 1.5cm diameter, spaced apart
        % Equilateral triangle with 2.2cm between centers

        \node[circle, fill=hdxpurple, text=white, minimum size=1.5cm, font=\tiny\bfseries] (conf) at (0,1.3) {Confidentiality};
        \node[circle, fill=hdxpurple, text=white, minimum size=1.5cm, font=\tiny\bfseries] (int) at (-1.5,-0.7) {Integrity};
        \node[circle, fill=hdxpurple, text=white, minimum size=1.5cm, font=\tiny\bfseries] (avail) at (1.5,-0.7) {Availability};
...
\begin{frame}{The OT Security Tetrad: Adding Safety}
    ...
    \begin{tikzpicture}
        ...
        % Diamond layout: Safety at center, CIA at four cardinal points
        % All same size (1.5cm), Safety highlighted by color only

        % Safety in center
        \node[circle, fill=hdxgreen, text=white, minimum size=1.5cm, font=\tiny\bfseries] (safe) at (0,0) {Safety};

        % CIA at cardinal points, well spaced from center
        \node[circle, fill=hdxpurple, text=white, minimum size=1.5cm, font=\tiny\bfseries] (conf) at (0,2.5) {Confidentiality};
        \node[circle, fill=hdxpurple, text=white, minimum size=1.5cm, font=\tiny\bfseries] (int) at (-2.5,0) {Integrity};
        \node[circle, fill=hdxpurple, text=white, minimum size=1.5cm, font=\tiny\bfseries] (avail) at (2.5,0) {Availability};
