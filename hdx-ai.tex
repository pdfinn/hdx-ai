...
\begin{frame}{The CIA Triad: Foundation of Information Security}
    ...
    \begin{tikzpicture}
        ...
        % All circles exactly 1.8cm - using inner sep=0pt to prevent text from expanding circle
        % Text width constrains the text to wrap inside the circle

        \node[circle, fill=hdxpurple, text=white, minimum size=1.8cm, inner sep=0pt, font=\tiny\bfseries, align=center, text width=1.5cm] (conf) at (0,1.5) {Confiden-\\tiality};
        \node[circle, fill=hdxpurple, text=white, minimum size=1.8cm, inner sep=0pt, font=\tiny\bfseries, align=center] (int) at (-1.7,-0.8) {Integrity};
        \node[circle, fill=hdxpurple, text=white, minimum size=1.8cm, inner sep=0pt, font=\tiny\bfseries, align=center, text width=1.5cm] (avail) at (1.7,-0.8) {Avail-\\ability};
...
\begin{frame}{The OT Security Tetrad: Adding Safety}
    ...
    \begin{tikzpicture}
        ...
        % All circles exactly 1.8cm - using inner sep=0pt to prevent text expansion
        % Safety in center, CIA at cardinal points

        \node[circle, fill=hdxgreen, text=white, minimum size=1.8cm, inner sep=0pt, font=\tiny\bfseries, align=center] (safe) at (0,0) {Safety};
        \node[circle, fill=hdxpurple, text=white, minimum size=1.8cm, inner sep=0pt, font=\tiny\bfseries, align=center, text width=1.5cm] (conf) at (0,2.5) {Confiden-\\tiality};
        \node[circle, fill=hdxpurple, text=white, minimum size=1.8cm, inner sep=0pt, font=\tiny\bfseries, align=center] (int) at (-2.5,0) {Integrity};
        \node[circle, fill=hdxpurple, text=white, minimum size=1.8cm, inner sep=0pt, font=\tiny\bfseries, align=center, text width=1.5cm] (avail) at (2.5,0) {Avail-\\ability};

        % Lines from CIA to Safety (emphasized)
        \draw[thick, hdxgreen] (conf) -- (safe);
        \draw[thick, hdxgreen] (int) -- (safe);
        \draw[thick, hdxgreen] (avail) -- (safe);

        % CIA interconnections (lighter, outer edges)
