...
\begin{frame}{The CIA Triad: Foundation of Information Security}
    ...
    \begin{tikzpicture}[scale=0.9]
        ...
        \node[circle, fill=hdxpurple, text=white, minimum size=3.5cm, font=\large\bfseries] (conf) at (0,2.5) {Confidentiality};

        % Bottom left circle - Integrity
        \node[circle, fill=hdxpurple, text=white, minimum size=3.5cm, font=\large\bfseries] (int) at (-3,-1.5) {Integrity};

        % Bottom right circle - Availability
        \node[circle, fill=hdxpurple, text=white, minimum size=3.5cm, font=\large\bfseries] (avail) at (3,-1.5) {Availability};
...
\begin{frame}{The OT Security Tetrad: Adding Safety}
    ...
    \begin{tikzpicture}[scale=0.8]
        ...
        % Diamond arrangement
        % Top - Confidentiality
        \node[circle, fill=hdxpurple, text=white, minimum size=2.8cm, font=\normalsize\bfseries] (conf) at (0,3) {Confidentiality};

        % Left - Integrity
        \node[circle, fill=hdxpurple, text=white, minimum size=2.8cm, font=\normalsize\bfseries] (int) at (-3.5,0) {Integrity};

        % Right - Availability
        \node[circle, fill=hdxpurple, text=white, minimum size=2.8cm, font=\normalsize\bfseries] (avail) at (3.5,0) {Availability};

        % Bottom - Safety (highlighted)
        \node[circle, fill=hdxgreen, text=white, minimum size=2.8cm, font=\normalsize\bfseries] (safe) at (0,-3) {Safety};
...
\begin{frame}{Confidentiality}
    \begin{columns}[c]
        \begin{column}{0.6\textwidth}
            ...
            \begin{alertblock}{AI Concern}
                Can the model be manipulated to reveal training data or system prompts?
            \end{alertblock}
        \end{column}
        \begin{column}{0.35\textwidth}
            ...
            \begin{tikzpicture}
                \definecolor{hdxpurple}{RGB}{102,51,153}
                \node[circle, fill=hdxpurple, text=white, minimum size=3cm, font=\large\bfseries] {C};
            \end{tikzpicture}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Integrity}
    \begin{columns}[c]
        ...
        \begin{column}{0.35\textwidth}
            ...
            \begin{tikzpicture}
                \definecolor{hdxpurple}{RGB}{102,51,153}
                \node[circle, fill=hdxpurple, text=white, minimum size=3cm, font=\large\bfseries] {I};
            \end{tikzpicture}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Availability}
    \begin{columns}[c]
        \begin{column}{0.6\textwidth}
            ...
            \begin{alertblock}{AI Concern}
                Can the model be overwhelmed, degraded, or taken offline by attackers?
            \end{alertblock}
        \end{column}
        \begin{column}{0.35\textwidth}
            \centering
            \begin{tikzpicture}
                \definecolor{hdxpurple}{RGB}{102,51,153}
                \node[circle, fill=hdxpurple, text=white, minimum size=3cm, font=\large\bfseries] {A};
            \end{tikzpicture}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Defence in Depth}
    ...
    \begin{tikzpicture}[scale=0.85]
        ...
        \node[draw=layer1, fill=layer1!30, minimum width=12cm, minimum height=5.5cm, rounded corners=5pt] (outer) at (0,0) {};
        \node[draw=layer2, fill=layer2!30, minimum width=9.5cm, minimum height=4.2cm, rounded corners=5pt] at (0,0) {};
        \node[draw=layer3, fill=layer3!30, minimum width=7cm, minimum height=3cm, rounded corners=5pt] at (0,0) {};
        \node[draw=layer4, fill=layer4!30, minimum width=4.5cm, minimum height=1.8cm, rounded corners=5pt] at (0,0) {};

        % Labels
        \node[font=\small\bfseries, text=layer4] at (0,0) {Critical Assets};
        \node[font=\small, text=layer3] at (0,-1.1) {Application Security};
        \node[font=\small, text=layer2] at (0,-1.8) {Network Security};
        \node[font=\small, text=layer1] at (0,-2.5) {Perimeter Security};

        % Side labels
        \node[font=\footnotesize, anchor=west] at (5.5,2) {Firewalls, IDS};
        \node[font=\footnotesize, anchor=west] at (5.5,0.8) {Segmentation, VPNs};
        \node[font=\footnotesize, anchor=west] at (5.5,-0.4) {Input validation, Auth};
        \node[font=\footnotesize, anchor=west] at (5.5,-1.6) {Encryption, Access control};
    \end{tikzpicture}

    \vspace{3mm}

    \textbf{Principle}: No single security control is sufficient.\\Multiple layers ensure that if one fails, others still protect.
\end{frame}
...
\begin{frame}{Guardrails: Protecting AI at the Boundary}
    ...
    \begin{tikzpicture}[scale=0.9, every node/.style={font=\small}]
        ...
        % User silhouette (simplified head shape)
        \node[circle, fill=gray!40, minimum size=1.2cm] (head) at (-5,0.5) {};
        \node[trapezium, fill=gray!40, minimum width=1.5cm, minimum height=0.8cm, trapezium angle=70] at (-5,-0.5) {};

        % Prompt Guardrails box
        \node[draw=hdxgreen, fill=hdxgreen!80, text=white, minimum width=2.5cm, minimum height=1.5cm, rounded corners=3pt, font=\bfseries, align=center] (prompt) at (-1.5,1.5) {Prompt\\Guardrails};

        % Response Guardrails box
        \node[draw=hdxgreen, fill=hdxgreen!80, text=white, minimum width=2.5cm, minimum height=1.5cm, rounded corners=3pt, font=\bfseries, align=center] (response) at (-1.5,-1.5) {Response\\Guardrails};

        % LLM box
        \node[draw=hdxblue, fill=hdxblue!80, text=black, minimum width=2.5cm, minimum height=2.5cm, rounded corners=3pt, font=\Large\bfseries] (llm) at (3,0) {LLM};

        % Arrows
        \draw[->, thick, black] (-4,0.5) -- (prompt.west);
        \draw[->, thick, black] (prompt.east) -- (llm.north west);
        \draw[->, thick, black] (llm.south west) -- (response.east);
        \draw[->, thick, black] (response.west) -- (-4,-0.5);
    \end{tikzpicture}
...
\begin{frame}{Defence in Depth for AI Guardrails}
    ...
    \begin{tikzpicture}[scale=0.75, every node/.style={font=\footnotesize}]
        ...
        % User
        \node[circle, fill=gray!40, minimum size=0.8cm] at (-6.5,0.3) {};
        \node[trapezium, fill=gray!40, minimum width=1cm, minimum height=0.5cm, trapezium angle=70] at (-6.5,-0.3) {};

        % Multiple input guardrail layers
        \node[draw=hdxgreen!70, fill=hdxgreen!20, minimum width=1.2cm, minimum height=2.5cm, rounded corners=2pt] (g1) at (-4.5,0) {};
        \node[draw=hdxgreen!80, fill=hdxgreen!30, minimum width=1.2cm, minimum height=2.5cm, rounded corners=2pt] (g2) at (-3.3,0) {};
        \node[draw=hdxgreen!90, fill=hdxgreen!40, minimum width=1.2cm, minimum height=2.5cm, rounded corners=2pt] (g3) at (-2.1,0) {};

        % Labels for input guardrails
        \node[rotate=90, font=\tiny] at (-4.5,0) {Pattern Filter};
        \node[rotate=90, font=\tiny] at (-3.3,0) {Intent Classifier};
        \node[rotate=90, font=\tiny] at (-2.1,0) {Context Check};

        % LLM
        \node[draw=hdxblue, fill=hdxblue!60, minimum width=1.8cm, minimum height=2.5cm, rounded corners=3pt, font=\normalsize\bfseries] (llm) at (0,0) {LLM};

        % Multiple output guardrail layers
        \node[draw=hdxgreen!90, fill=hdxgreen!40, minimum width=1.2cm, minimum height=2.5cm, rounded corners=2pt] (o1) at (2.1,0) {};
        \node[draw=hdxgreen!80, fill=hdxgreen!30, minimum width=1.2cm, minimum height=2.5cm, rounded corners=2pt] (o2) at (3.3,0) {};
        \node[draw=hdxgreen!70, fill=hdxgreen!20, minimum width=1.2cm, minimum height=2.5cm, rounded corners=2pt] (o3) at (4.5,0) {};

        % Labels for output guardrails
        \node[rotate=90, font=\tiny] at (2.1,0) {PII Filter};
        \node[rotate=90, font=\tiny] at (3.3,0) {Policy Check};
        \node[rotate=90, font=\tiny] at (4.5,0) {Toxicity Filter};

        % Arrows
        \draw[->, thick] (-5.8,0) -- (g1.west);
        \draw[->, thick] (o3.east) -- (5.5,0);

        % Brace labels
        \draw[decorate, decoration={brace, amplitude=5pt, mirror}] (-4.9,-1.5) -- (-1.7,-1.5) node[midway, below=5pt, font=\small] {Input Layers};
        \draw[decorate, decoration={brace, amplitude=5pt, mirror}] (1.7,-1.5) -- (4.9,-1.5) node[midway, below=5pt, font=\small] {Output Layers};
    \end{tikzpicture}
