...
\begin{frame}{Today's Agenda}
    ...
    \hdxtopicitem{3}{Strategic Considerations}{Maturity, vendors, and talent}
...
\begin{frame}{Part 2 Key Takeaways}
    ...
    \begin{minipage}{0.9\textwidth}
        \begin{enumerate}
            ...
            \item \textbf{Prompt Injection}: The critical threat with no complete solution

            \item \textbf{Governance Matters}: Three lines of defense

            \item \textbf{People are Hardest}: Invest in talent and culture
        \end{enumerate}
    \end{minipage}
\end{frame}
}
