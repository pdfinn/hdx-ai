...
\begin{frame}{Jailbreak Debrief}
    \textbf{What techniques did you try?}

    \vspace{3mm}

    \begin{columns}[t]
        \begin{column}{0.48\textwidth}
            \textbf{Common Jailbreak Patterns:}
            \begin{itemize}
                \item Role-playing / persona
        ...
        \begin{column}{0.48\textwidth}
            \textbf{Why They Work:}
            \begin{itemize}
                \item Models are trained to be helpful
                \item Context manipulation
                \item Safety training has gaps
                \item Adversarial prompts exploit edge cases
            \end{itemize}
        \end{column}
    \end{columns}
