...
\subtitle{Part 2: Ethics, Data Security, and Product Implementation}
...
\begin{frame}{Today's Agenda}
    ...
    \hdxtopicitem{4}{Strategic Considerations}{Maturity, vendors, and talent}

    \vspace{3mm}

    {\small\textit{Duration: 2 hours}}
\end{frame}
...
\begin{frame}{Feedback Loops}
    ...
    \begin{tikzpicture}[scale=0.8, every node/.style={font=\small}]
        ...
        % Arrows
        \draw[->, thick] (users) -- (ai) node[midway, above] {Inputs};
        \draw[->, thick] (ai) -- (analytics) node[midway, above] {Outputs};
        \draw[->, thick] (analytics) -- (improve) node[midway, right] {Insights};
        \draw[->, thick] (improve) -- (ai) node[midway, left] {Updates};
        \draw[->, thick, dashed] (users) to[bend right=30] node[midway, below] {Feedback} (improve);
    \end{tikzpicture}
